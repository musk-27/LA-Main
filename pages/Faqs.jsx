      ...
      <div className="faqsPage">
        ...
        <div className="faqMainList">
          <div className="mainListInner">
            ...
            >
              <div onClick={scrollToAdmissionSection} className="elementText">
                <h4>admissions</h4>
              </div>
              <div
            ...
            >
              <div onClick={scrollToOperationalSection} className="elementText">
            ...
            >
              <div onClick={scrollToCurriculumSection} className="elementText">

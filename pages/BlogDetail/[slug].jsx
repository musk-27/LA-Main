...
// // // //   try {
// // // //     const res = await fetch(
// // // //       "https://strapi.littlearyans.in/api/blogs?populate[slug]=*"
// // // //     );
// // // //     const { data } = await res.json();
...
//     );
//     const data = await res.json();
//     const allBlogsRes = await fetch("https://strapi.littlearyans.in/api/blogs?populate=*");
//     const allBlogsData = await allBlogsRes.json();

//     return {
//       props: {
//         data: data.data,
//         allBlogs: allBlogsData.data.map((blog) => ({
//           slug: blog.attributes.slug,
//           title: blog.attributes.Title,
//           type: blog.attributes.Type,
//           BlogDate: blog.attributes.BlogDate,

...
const LAHome = () => {
  ...
  return (
    <div>
      <Head>
        <title>Little Aryans Home</title>
      </Head>
      <Facebook />
      <div className="LAHome">
        {/* Tagline */}
        ...
        {/* Seeing Beyond Self */}
        <div className="homeSeeBeyondSelf">
          <div className="row">
            <div className="col-lg-6 d-flex justify-content-center align-items-center">
              <div className="homeSeeBeyondSelfImg">
                <Image src={SeeBeyondSelfImg} alt="seeBeyondSelf" />
              </div>
            </div>
            <div className="col-lg-6 d-flex align-items-center">
              <div className="homeSeeBeyondSelfText">
                <h3>Seeing Beyond Self</h3>
                <h4>
                  At Little Aryans, we encourage children to recognize their
                  potential and believe in their abilities. Our holistic
                  approach fosters self-awareness and a sense of self-worth,
                  essential for their growth and development.
                </h4>
                <h4>
                  By helping them understand their strengths and how they can
                  contribute to the world, we prepare them to face challenges
                  confidently and contribute positively to society.
                </h4>
              </div>
            </div>
          </div>
        ...
        <div className="homeCurriculum">
          <div className="row">
            <div className="col-lg-6">
              <div className="homeCurriculumText">
                <h3>Our Curriculum</h3>
                <h4>
                  Our curriculum is designed to meet the needs of each child,
                  providing a well-rounded education that includes academic,
                  social, and emotional development. We aim to create a balanced
                  learning environment that encourages curiosity and a love for
                  learning.
                </h4>
                <h4>
                  We integrate play-based learning with structured activities to
                  ensure that children are engaged and motivated. Our curriculum
                  supports their growth in all areas, helping them to become
                  confident and capable individuals.
                </h4>
              </div>
            </div>
            <div className="col-lg-6 d-flex justify-content-center align-items-center">
              <div className="homeCurriculumImg">
                <Image src={CurriculumHomeImg} alt="curriculum" />
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Pedagogy */}
        <div className="homePedagogy">
          <div className="row">
            <div className="col-lg-6 d-flex justify-content-center align-items-center">
              <div className="homePedagogyImg">
                <Image src={PedagogyHomeImg} alt="pedagogy" />
              </div>
            </div>
            <div className="col-lg-6">
              <div className="homePedagogyText">
                <h3>Our Pedagogy</h3>
                <h4>
                  Our pedagogy focuses on creating an enriching learning
                  environment where children can explore, learn, and grow. We
                  use innovative teaching methods that cater to the diverse needs
                  of our students.
                </h4>
                <h4>
                  We believe in a child-centered approach that values each
                  child's unique learning style. Our pedagogy encourages active
                  participation and fosters a love for learning through
        ...
        {/* Vasudev Kutumbh */}
        <div className="homeVasudevKutumbh">
          <div className="row">
            <div className="col-lg-6 d-flex justify-content-center align-items-center">
              <div className="homeVasudevKutumbhImg">
                <Image src={VasudevKutumbhImg} alt="vasudevKutumbh" />
              </div>
            </div>
            <div className="col-lg-6">
              <div className="homeVasudevKutumbhText">
                <h3>Vasudev Kutumbh</h3>
                <h4>
                  At Little Aryans, we foster a sense of community and
                  togetherness. Our values are deeply rooted in the belief that
                  we are all part of a larger family.
                </h4>
                <h4>
                  We emphasize the importance of empathy, respect, and
                  collaboration. By nurturing these values, we help children
                  develop a strong sense of belonging and responsibility towards
        ...
        {/* Online Learning */}
        <div className="homeOnlineLearning">
          <div className="row">
            <div className="col-lg-6">
              <div className="homeOnlineLearningText">
                <h3>Online Learning</h3>
                <h4>
                  Our online learning platform provides a flexible and engaging
                  way for children to continue their education from home. We
                  offer a range of interactive resources and activities that
                  support their learning journey.
                </h4>
                <h4>
                  Our online programs are designed to be interactive and
                  supportive, ensuring that children remain motivated and
                  connected with their peers and teachers.
                </h4>
              </div>
            </div>
            <div className="col-lg-6 d-flex justify-content-center align-items-center">
              <div className="homeOnlineLearningImg">
                <Image src={OnlineLearningHomeImg} alt="onlineLearning" />
              </div>
            </div>
          </div>
        </div>

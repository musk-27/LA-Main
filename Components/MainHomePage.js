          ...
          <div className="LAHome">
              ...
              <div className="row">
                <div className="col-lg-5">
                  <div className="leftBelowBanner">
                    <h4>
                      ...
                      children&apos;s brains are growing rapidly, and most
                      neural pathways are formed. They are learning about the
                      world around them, becoming self-aware, and developing
                      their self-esteem.
                    </h4>
                    <h4 className="mt-5">
                      This stage in their lives charts the course of their
                      future. This is also when they’ll be most adaptable to new
                      experiences.
                    </h4>
                  </div>
                </div>
                ...
                <div className="col-lg-5">
                  <div className="rightBelowBanner">
                    <h3>
                      To reach their full potential in the future, even outside
                      of school, every child needs to start with holistic
                      education.
                    </h3>
                ...
                <div className="col-lg-5">
                  <div className="leftBelowBanner">
                    <h4>
                      ...
                      one family &quot;. It is based on the belief that all
                      living beings are interconnected. Meaning, we have a
                      responsibility to care for each other and to work together
                      for the common good.
                    </h4>
                    <h4 className="mt-5">
                      We teach every child that they are part of something
                      bigger than themselves because it
                    </h4>
                    <ul>
                ...
                <div className="col-lg-5">
                  <div className="startingStrongText">
                    ...
                    <ol className="mt-5">
                      ...
                      <li className="mt-4">
                        <h4>
                          We have a nurturing environment where children feel
                          safe and supported.
                        </h4>
                      </li>
                      <li className="mt-4">
                  ...
                  <div className="col-md-4 d-flex justify-content-center">
                    <div className="otherPageLink">
                      ...
                      <div className="otherPageLinkText">
                        <h3>Pedagogy</h3>
                        <p>
                          Our approach is built on learnings from various
                          pedagogies like Montessori and Kindergarten. All for
                          promoting self-learning and self-discovery.
                        </p>
                        <Link href="/Pedagogy">
                          <div className="knowMoreBtn">
                            <h6>KNOW MORE</h6>
                    ...
                    <div className="otherPageLink">
                      ...
                      <div className="otherPageLinkText">
                        ...
                        <p>
                          ...
                          with experiential hands-on learning kits. For children
                          who can’t go to school for some reason.
                        </p>
            ...
            <div className="homeApplyNow">
              <div className="homeApplyHead">
                <h1>Apply Now</h1>
                <h4>
                  Get your child started on the journey to become the best
                  version of themselves.Get them to be a Little Aryan.
                </h4>
                <Link href="/ApplyNow">
                  <div className="knowMoreBtn">
                    <h6>KNOW MORE</h6>

...
import { Autoplay, Navigation } from "swiper";
// JSON
import useFetch from "../hooks/useFetch"; // Adjusted path to useFetch
        ...
        <div className="schoolTourPage">
          ...
          <div className="lessPaddingInfoSection">
            <div className="infoSectionInner">
              <div className="schoolTourDescText">
                <p>
                  A Little Aryans classroom has kids’ rooms, discovery centres, AV room, open spaces, play areas, gardens, and lots more. We give utmost importance to the safety of our children. All the recreational areas have shock absorbent flooring and the children are supervised at all times.
                </p>
              </div>
              <div className="schoolTourDescImage">
                <Image src="/Images/SchoolTourImg.png" alt="Toddler Activities" />
              </div>
            </div>
          </div>
          ...
          <div className="schoolTourDescSection">
            <div className="schoolTourDescInner">
              <p>
                Children here explore with beautiful and appealing play equipment (Non-toxic, child-friendly, and scientifically designed) that is equipped with learning material, state-of-the-art technology, and an extensive library which comprises of books, magazines, periodicals and educational DVDs. We have introduced Interactive Boards which enhance visual imagination, creativity, and concept clarity. We also have designed a medical area equipped with a first aid kit in case of any emergency.
              </p>
            </div>
          </div>
          ...
          <div className="schoolTourListSection">
            <div className="row">
              <div className="col-md-6">
                <div className="schoolTourList">
                  <ul>
                    <li><h5>WELL VENTILATED CLASSROOMS</h5></li>
                    <li><h5>DISCOVERY CENTERS</h5></li>
                    <li><h5>NATURE’S LAB - ‘LEARNING AMIDST NATURE’</h5></li>
                    <li><h5>ART ROOM WITH ABUNDANT ACTIVITY MATERIAL</h5></li>
                    <li><h5>MUSIC AND DANCE ROOM</h5></li>
                    <li><h5>NON TOXIC, SAFE TOYS & CREATIVE TEACHING AIDS</h5></li>
                    <li><h5>WATER PLAY STATION</h5></li>
                    <li><h5>SAND PIT</h5></li>
                    <li><h5>AUDIO VISUAL ROOM (AIR CONDITIONED)</h5></li>
                    <li><h5>INTERACTIVE BOARD</h5></li>
                    <li><h5>LIBRARY</h5></li>
                    <li><h5>PUPPET THEATRE</h5></li>
                    <li><h5>UNINTERRUPTED POWER SUPPLY</h5></li>
                    <li><h5>500 CAPACITY AUDITORIUM</h5></li>
                    <li><h5>CCTV IN CLASSROOMS</h5></li>
                    <li><h5>TRANSPORTATION WITH APP TRACKING</h5></li>
                    <li><h5>CHILD PROOF DOORS WITH SAFETY LOCKS</h5></li>
                    <li><h5>PLAYGROUND & SPORTS FACILITIES FOR INDOORS AND OUTDOORS</h5></li>
                  </ul>
                </div>
              </div>
            </div>

      ...
      <Layout metaData={metaData}>
        <div className="LAHome">
            ...
            <div className="row">
              <div className="col-lg-5 d-flex align-items-center">
                <div className="rightBelowBanner">
                  ...
                  <div className="rightBelowBannerImg rightBelowBannerImgLeft">
                    <Image
                      src={images.otherImages.vasudevKutumbh}
                      alt="vasudevKutumbh"
                      layout="responsive"
              ...
              <div className="col-lg-5">
                <div className="rightBelowBanner">
                  <h2>
                    Our commitment goes beyond the self and focuses on the
                    betterment of the world at large. Through the core value of
                    Vasudeva Kutumbakam, we strive to create a positive impact
          ...
          <div className="Pedagogy">
            <div className="row">
              <div className="col-lg-6">
                <div className="PedagogyContent">
                  <h3>Our Pedagogy</h3>
                  <p>
                    Our approach to early childhood education is centered around
                    play-based learning. This method helps children to learn and
                    grow in a natural, engaging way. We believe in fostering
                    creativity, critical thinking, and social skills through
                    diverse, interactive activities.
                  </p>
                </div>
              </div>
              <div className="col-lg-6 d-flex justify-content-center align-items-center">
                <div className="PedagogyImage">
                  <Image
                    src={images.otherImages.pedagogyHome}
                    alt="Pedagogy"
                    layout="responsive"
          ...
          <div className="OnlineLearning">
            <div className="row">
              <div className="col-lg-6 d-flex justify-content-center align-items-center">
                <div className="OnlineLearningImage">
                  <Image
                    src={images.otherImages.onlineLearningHome}
                    alt="Online Learning"
                    layout="responsive"
              ...
              <div className="col-lg-6">
                <div className="OnlineLearningContent">
                  <h3>Online Learning</h3>
                  <p>
                    We offer a range of online learning opportunities to support
                    our students’ educational journey. Our virtual classrooms
                    and resources are designed to complement our in-person
                    programs and provide flexible, accessible learning options.
                  </p>
                </div>
              </div>
            </div>

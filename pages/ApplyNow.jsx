        ...
        <div>
          <div className="applyNowPage">
            ...
            <div className="applyHead">
              <h3>
                To launch your child’s incredible learning journey, read the
                details herewith.
              </h3>
            </div>
            {/* End Apply Header */}
                      ...
                      <ol>
                        <li>
                          ...
                          <Link
                            ...
                            // href="/Admission"
                          >
                            Apply online via the Little Aryans application
                            portal
                          </Link>
                        </li>
                  ...
                  <div className="applyNowStepsText">
                    <div className="applyNowStep">
                      <div className="impNoticeText">
                        <ul>
                          <li>
                            The admission for academic year 24-25 begins online
                            from 24th Oct 2023.{" "}
                          </li>
                          <li>
                            <div className="stepsBreakLine">
                          ...
                          <li>
                            {" "}
                            All admission details are available after the
                          ...
                          <li>
                            All those seeking admission must produce
                            satisfactory evidence of his/her date of birth such
                            as a certificate from Municipal or village records.
                          </li>
                          <li>
                            <div className="stepsBreakLine">
                              <Image

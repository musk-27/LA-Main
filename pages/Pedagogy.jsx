  ...
  return (
    <div className="pedagogyPage">
          ...
          <div className="col-lg-6 d-flex align-items-center">
            <div className="pedagogyDescText">
              <h4>
                ...
                Kindergarten, and incorporated them into our methods. Not before
                making them relevant for our children today.
              </h4>
            </div>
          </div>
      ...
      <div className="essenceChinmaya">
        <h3>
          Everything we do is built on the four pillars of the Chinmaya Vision
          Program.
        </h3>
      </div>
              ...
              <ul>
                ...
                <li>
                  <h4>
                    ...
                    centres: Alpha Centre, Math Centre, Theme Centre & Language
                    Development Program (LDP) Centre, Hindi and Marathi Centre.
                  </h4>
                </li>
              </ul>
            </div>
        ...
        <div className="row">
          <div className="col-lg-5 d-flex align-items-center">
            <div className="entegratedPara1">
              <h4>
                When we teach a child about a plant’s life cycle, we also get
                them to collect data. We teach them about sequences and
                progression by counting the number of leaves they see each day.
                We level up their vocabulary by getting them to name the parts
                of the plant.  
              </h4>
            </div>
          </div>
      ...
      <div className="entegratedLearningSection">
        <div className="row">
          <div className="col-lg-5 d-flex align-items-center">
            <div className="entegratedPara1">
              <h2>
                The Bear Hunt Song. <br /> A classic example of this approach.
              </h2>
            </div>
          </div>
          <div className="col-lg-2 d-flex justify-content-center">
        ...
        <div className="infoSectionInner">
          <div className="reggioPara2">
            <p>
              ...
              Painting, drawing, sculpting, dancing, singing, pretend play. Each
              of these languages is equally important. Just as play is in the
              learning process.
            </p>
            <p>
              We give a lot of importance to observation and documentation. And
              focus on building responsibility and ownership.
            </p>
            <p>
              It starts with our Integrated Settling Plan, developed to help
              pre-schoolers adjust to the new environment and overcome
              separation anxiety. From their first day, Little Aryans are taught
              differently. Science is taught through music. Mathematics with
              history. English with art and craft.
            </p>
          </div>
        </div>
      </div>
